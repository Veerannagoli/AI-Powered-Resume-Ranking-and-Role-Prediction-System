...
nltk.download('punkt_tab') # Needed for some newer versions
...
# DEBUG PRINT: This will show you in the terminal if the key loaded correctly
if GROQ_API_KEY:
    print(f"✅ API Key Loaded: {GROQ_API_KEY[:10]}...") 
else:
    print("❌ ERROR: API Key failed to load from .env file!")
